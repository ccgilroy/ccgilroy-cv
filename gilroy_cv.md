...
Jeffrey Arnold, Connor Gilroy, Daiki Hiramori, and Stephen Winkler. ``Gendered Language Characteristics and Support for Homosexuality: An Exploratory Analysis of Afrobarometer Data."

Connor Gilroy. ``Demographic Change in Gay Neighborhoods." \textit{Master's Thesis}

Kate Stovel and Connor Gilroy. ``Social Structure and Change in Public Opinion: The Case of Same-Sex Marriage." Invited book chapter for \textit{Architecture of the Social}, Peter Hedström and Petri Ylikoski, editors. \textit{Draft submitted September 2016}
...
Best Poster (co-winner), Fall Lightning Talks and Poster Session, Center for Studies in Demography and Ecology, University of Washington. (for "Extending the Demography of Sexuality with Digital Trace Data")
