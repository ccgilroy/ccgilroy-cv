...
- **Statistical modeling:** GLMs, hierarchical models, regularized regression, Bayesian statistics
...
- Statistical modeling and visualization of gender-based disparities in Central Asia (with Stephen Winkler, supervisor Audrey Sacks) | **R** | [story based on analysis](https://www.worldbank.org/en/news/feature/2021/03/08/women-must-play-a-central-role-in-uzbekistans-recovery-from-the-pandemic)
...
Reviews for *American Sociological Review*, *Socius*, *Demographic Research*, *CHI*, *Journal of Homosexuality*
